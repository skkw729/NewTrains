...
{
	public static TrainSchedule importSchedule()
	{
		Scanner stations;
		Scanner connections;
		Scanner trainlines;
		TrainSchedule schedule = new TrainSchedule();
		stations = new Scanner(ImportSchedule.class.getResourceAsStream("stations.csv"));//could throw NullPointerException
		connections = new Scanner(ImportSchedule.class.getResourceAsStream("connections.csv"));
		trainlines = new Scanner(ImportSchedule.class.getResourceAsStream("trainlines.csv"));
